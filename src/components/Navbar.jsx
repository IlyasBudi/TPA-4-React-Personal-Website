            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <Link to={"/"} className="hover:bg-slate-700 text-white px-3 py-2 rounder-md text-sm font-medium">
                    Home
                  </Link>
                  ...
                  <Link to={"/education"} className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
                    Education
                  </Link>

                  <Link to={"/portofolio"} className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
                    Portofolio
                  </Link>
